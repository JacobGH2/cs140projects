...
public class Example4c {
	...
	private String[] buttonLabels = {"row 0 column 0", "row 0 column 1",
			...
			"row 4 column 2"};
	private String[] labelLabels = {"row 0 column 3", "row 1 column 3",
			"row 2 column 3", "row 3 column 3",	"row 4 column 3"};
	private JButton[] buttons = new JButton[buttonLabels.length];
	private JLabel[] labels = new JLabel[labelLabels.length];
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				new Example4c().createAndShowGUI();
			}
		});
	}
	...
	public void createAndShowGUI() {
		...
		int[][] constraints = new int[buttons.length + labels.length][3];
		// button row 1
		// put button at (0, 0)
		...
		list.add(buttons[buttonIndex++]);
		// put button at (0, 2)
		constraints[j++] = new int[] {2, 0, 1};
		list.add(buttons[buttonIndex++]);
		// put label at (0, 3)
		constraints[j++] = new int[] {3, 0, GridBagConstraints.REMAINDER};
		list.add(labels[labelIndex++]);
		// button row 2
		// put button at (1, 0)
		constraints[j++] = new int[] {0, 1, 2}; // occupy 2 columns
		list.add(buttons[buttonIndex++]);
		// put button at (1, 2)
		constraints[j++] = new int[] {2, 1, 1};
		list.add(buttons[buttonIndex++]);
		// put label at (1, 3)
		constraints[j++] = new int[] {3, 1, GridBagConstraints.REMAINDER};
		list.add(labels[labelIndex++]);
		// button row 3
		// put button at (2, 0)
		...
		list.add(buttons[buttonIndex++]);
		// put button at (2, 1)
		constraints[j++] = new int[] {1, 2, 2}; // occupy 2 columns
		list.add(buttons[buttonIndex++]);
		// put label at (2, 3)
		constraints[j++] = new int[] {3, 2, GridBagConstraints.REMAINDER};
		list.add(labels[labelIndex++]);
		// button row 4
		// put button at (3, 0)
		...
		list.add(buttons[buttonIndex++]);
		// put button at (3, 2)
		constraints[j++] = new int[] {2, 3, 1};
		list.add(buttons[buttonIndex++]);
		// put label at (3, 3)
		constraints[j++] = new int[] {3, 3, GridBagConstraints.REMAINDER};
		list.add(labels[labelIndex++]);
		// button row 5
		// put button at (4, 0)
		...
		list.add(buttons[buttonIndex++]);
		// put label at (4, 3)
		constraints[j++] = new int[] {3, 4, GridBagConstraints.REMAINDER};
		list.add(labels[labelIndex++]);
		...
		for(int i = 0; i < list.size(); i++) {
			...
			gridBagLayout.setConstraints(list.get(i), buttonPanelConstraints);
