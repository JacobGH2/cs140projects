		...
		try (BufferedReader input = new BufferedReader(
			...
			for(int i = 0; i < inputLines.size(); ) { // i is incremented in the loop
				...
				if(inn.startsWith("new EnhancedBankAccount")) {
					...
					eba.updateTransactions();
					
					// testing arrayList returning methods
					System.out.println();
					System.out.println("succesful " + eba.getAllSuccessfulTransactions().toString());
					System.out.println("failed " + eba.getAllFailedTransactions().toString());
					System.out.println("savings deposit " + eba.getSavingsDepositTransactions().toString());
					System.out.println("checking deposit " + eba.getCheckingDepositTransactions().toString());
					System.out.println("savings withdraw " + eba.getSavingsWithdrawalTransactions().toString());
					System.out.println("checking withdraw " + eba.getCheckingWithdrawalTransactions().toString());
					System.out.println("savings to checking " + eba.getSavingsToCheckingTransferTransactions().toString());
					System.out.println("checking to savings " + eba.getCheckingToSavingsTransferTransactions().toString());
					LocalDate start = LocalDate.of(2022, 1, 7);
					LocalDate end = LocalDate.of(2022, 3, 8);
					System.out.println("failed dates" + eba.getFailedTransactions(start, end));
					System.out.println("succesful dates " + eba.getSuccessfulTransactions(start, end));
